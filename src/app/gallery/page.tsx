...
const galleryImages = [
    ...
    { id: 'amb-4', src: 'https://exlaucgslmfiakllbtnq.supabase.co/storage/v1/object/public/Additional/AMB4.jpg', alt: 'Cafe ambiance', title: 'Modern & Cozy', category: 'Ambience' },
                    ...
                    {galleryImages.map((image) => (
                        ...
                        >
                            ...
                            <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col items-center justify-center p-4">
                                ...
                                <h3 className="text-white font-headline text-xl text-center translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                                    {image.title}
                                </h3>
                ...
                <DialogContent className="max-w-none w-screen h-screen bg-black/95 border-0 shadow-none p-0 flex items-center justify-center">
                    ...
                    {selectedImage && (
                        <div className="relative w-full h-full p-4 md:p-12 flex items-center justify-center">
                            ...
                            <div className="absolute bottom-8 left-1/2 -translate-x-1/2 text-center text-white hidden md:block">
                                <h2 className="font-headline text-3xl mb-2">{selectedImage.title}</h2>
