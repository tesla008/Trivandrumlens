...
const experienceImages = [
    // 1. Celebrity photo (always the first item)
    ...
    // 2. Other restaurant moments (experience, dining, atmosphere)
    ...
    // 3. Ambience photos (grouped at the bottom)
  ...
  return (
    <section className="py-20 md:py-32 bg-background/50 overflow-hidden">
      <div className="container mx-auto px-4 md:px-6">
        ...
        {/* Outlet videos removed from here as per Requirement 2 - They now live exclusively on the Gallery Page */}
