...
const GalleryGrid = ({ images }: { images: typeof combinedImages }) => (
    ...
    <section className="py-20 md:py-32 bg-background/50 overflow-hidden">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-16 space-y-4">
          ...
          <p className="text-lg text-foreground/70 max-w-2xl mx-auto italic">A visual journey through tradition, flavour, and family.</p>
        </div>
        <GalleryGrid images={combinedImages} />
      </div>
    </section>
  );
}
