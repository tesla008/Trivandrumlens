...
const menuImages = [
  ...
  { id: 'menu-4', src: 'https://exlaucgslmfiakllbtnq.supabase.co/storage/v1/object/public/Additional/menu4.jpg', alt: 'Menu Card Page 4' },
  ...
  { id: 'menu-7', src: 'https://exlaucgslmfiakllbtnq.supabase.co/storage/v1/object/public/Additional/menu7.jpg', alt: 'Menu Card Page 7' },
